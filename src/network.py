...
class Network(object):
    ...
    def __init__(self, sizes):
        ...
        network.  For example, if the list was [2, 3, 1] then it would be a three-layer network, 
        with the first layer containing 2 neurons, the second layer 3 neurons, and the third 
        layer 1 neuron.  The biases and weights for the network are initialized randomly, using  
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta, test_data=None):
        ...
        "training_data" is a list of tuples "(x, y)" represent the training inputs and
        the descired outputs. The other non-optional parameters are self-explanatory. If 
        ...
        but slows things down substiantially."""
